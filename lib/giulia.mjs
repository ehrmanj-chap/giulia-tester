...
function routeFallback(text) {
  ...
  const biz = /(business|work|manager|meeting|company|contract|gdp|econom|tax|client|professional|market|labor|labour|trade)/.test(t);
  const cul = /(culture|etiquette|family|social|language|dialect|gesture|tradition|religion|regional|italian)/.test(t);
